...
const FeaturesSplit = ({
  ...
  const sectionHeader = {
    title: 'Scraps that we deals with!!',
    paragraph: 'Scraps we currently dealing :-'
  };
          ...
          <div className={splitClasses}>
            ...
            <div className="split-item">
              ...
              <div className={
                ...
                <Image 
                  ...
                  src={require('./../../assets/images/ewaste.jpg')}
            ...
            <div className="split-item">
              <div className="split-item-content center-content-mobile reveal-from-right" data-reveal-container=".split-item">
                ...
                <p className="m-0">
                Metallic Waste means but is not limited to derelict vehicles, farm machinery, appliances and any other items, goods or things that are comprised entirely or mostly of a metal substance or substances.
                  </p>
              </div>
              <div className={
                classNames(
                ...
                data-reveal-container=".split-item">
                <Image
                  src={require('./../../assets/images/metal.jpg')}
            ...
            <div className="split-item">
              ...
              <div className={
                ...
                data-reveal-container=".split-item">
                <Image
                  src={require('./../../assets/images/plastic.png')}
